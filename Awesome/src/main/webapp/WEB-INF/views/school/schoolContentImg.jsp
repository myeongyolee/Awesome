...
<table id="clubcontentImg">
	...
	<form action="${pageContext.request.contextPath}/school/schoolContentImgEnd" method="post" enctype="multipart/form-data">
		...
		<div class="1" id="1" style="display: inline; margin-left: 20px; ">
			<img src="${pageContext.request.contextPath}/resources/images/sampleimage.png" id="img-viewer1" style="width:100px;">
		...
		<input type="hidden" name="memberCode" value="124"/>
...
function imgcountAdd(){
	...
	if(num2 == undefined && num3 == undefined){
		...
		HTML += "<input type='text' name='content2' id='content2' />";
		HTML += "</div>";
		HTML += "<br>";
		...
		HTML += "<input type='text' name='content3' id='content3' />";
		HTML += "</div>";
		HTML += "<br>";
		$("div.main-container").append(HTML);
	}
